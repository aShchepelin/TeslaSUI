...
struct CustomSliderView: View {
    ...
    var body: some View {
        GeometryReader { proxy in
            ...
            let scaleFactor = (maxSliderValue) / (Constants.Integer.chargeSliderRange.upperBound
                                ...
                                DragGesture(minimumDistance: 0)
                                    .onChanged { value in
                                        ...
                                        if value.translation.width > 0 {
                                            ...
                                            self.sliderValue = ((nextCoordinateValue)
                                                                / scaleFactor) + lowerRangeValue
                                        } else {
    ...
    private func sliderInternalField(_ height: CGFloat) -> some View {
        Capsule()
            .fill(
                LinearGradient(colors: [Color.darkShadow.opacity(0.7), Color.lightShadow],
